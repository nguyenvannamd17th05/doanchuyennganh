...
use App\Http\Controllers\admin\Tintuc;
...
Route::get('blogdetails/{id}',[BlogController::class,'details']);
//Route Admin
...
Route::prefix('admins')->middleware("authadmin")->group(function () {
    ...
    Route::prefix('nhansu')->group(function (){
        Route::get('list',[NhansuController::class,'list'])->name('admins.nhansu.list');
        Route::get('register',[NhansuController::class,'register'])->name('admins.nhansu.register');
        Route::post('register',[NhansuController::class,'insertrRegister'])->name('admins.nhansu.themregister');
        });
    Route::prefix('tintuc')->group(function(){
         Route::get('list',[Tintuc::class,'list'])->name('admins.tintuc.list');
        Route::get('insert',[Tintuc::class,'insert'])->name('admins.tintuc.insert');
        Route::post('inserted',[Tintuc::class,'inserted'])->name('admins.tintuc.inserted');
        });
